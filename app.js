...
const DEFAULT_MIXES = [
  { name:"1:2", code:"992", wb:41, sa:0, w1:275, w2:0, c1:0, c2:570, c3:0, s1:3.35, s2:0, s3:0, g1:1340, g2:0, g3:0, g4:0, a1:0, a2:0, a3:0, a6:0 },
  { name:"1:3", code:"993", wb:42, sa:0, w1:219, w2:0, c1:0, c2:520, c3:0, s1:2.6, s2:0, s3:0, g1:1560, g2:0, g3:0, g4:0, a1:0, a2:0, a3:0, a6:0 },
  { name:"25-18-80", code:"2781", wb:56.7, sa:60.4, w1:111, w2:48, c1:0, c2:252, c3:28, s1:331, s2:0, s3:773, g1:724, g2:0, g3:0, g4:0, a1:0, a2:2.8, a3:0, a6:0 },
  { name:"25-18-120", code:"2383", wb:56.7, sa:59.4, w1:116, w2:50, c1:0, c2:262, c3:29, s1:310, s2:0, s3:748, g1:730, g2:0, g3:0, g4:0, a1:0, a2:2.92, a3:0, a6:0 },
  { name:"25-18-150", code:"2784", wb:56.7, sa:59.6, w1:120, w2:52, c1:0, c2:273, c3:30, s1:317, s2:0, s3:740, g1:716, g2:0, g3:0, g4:0, a1:0, a2:3.03, a3:0, a6:0 },
  { name:"25-21-80", code:"2711", wb:53.3, sa:58.4, w1:112, w2:48, c1:0, c2:270, c3:30, s1:317, s2:0, s3:738, g1:752, g2:0, g3:0, g4:0, a1:0, a2:3, a3:0, a6:0 },
  { name:"25-21-120", code:"2713", wb:53.3, sa:57.4, w1:117, w2:50, c1:0, c2:282, c3:31, s1:306, s2:0, s3:714, g1:757, g2:0, g3:0, g4:0, a1:0, a2:3.13, a3:0, a6:0 },
  { name:"25-21-150", code:"2714", wb:53.3, sa:57.6, w1:121, w2:52, c1:0, c2:292, c3:32, s1:303, s2:0, s3:706, g1:713, g2:0, g3:0, g4:0, a1:0, a2:3.24, a3:0, a6:0 },
  { name:"25-24-120", code:"2743", wb:49.7, sa:55.7, w1:120, w2:51, c1:0, c2:310, c3:34, s1:291, s2:0, s3:678, g1:770, g2:0, g3:0, g4:0, a1:0, a2:3.44, a3:0, a6:0 },
  { name:"25-24-150", code:"2744", wb:49.7, sa:56, w1:123, w2:53, c1:0, c2:319, c3:35, s1:288, s2:0, s3:673, g1:755, g2:0, g3:0, g4:0, a1:0, a2:3.54, a3:0, a6:0 },
  { name:"25-24-180", code:"2745", wb:49.7, sa:57.2, w1:127, w2:55, c1:0, c2:330, c3:37, s1:290, s2:0, s3:676, g1:723, g2:0, g3:0, g4:0, a1:0, a2:3.67, a3:0, a6:0 },
  { name:"25-27-120", code:"2773", wb:46.1, sa:54.9, w1:120, w2:52, c1:0, c2:336, c3:37, s1:282, s2:0, s3:657, g1:771, g2:0, g3:0, g4:0, a1:0, a2:3.73, a3:0, a6:0 },
  { name:"25-27-150", code:"8288", wb:49.6, sa:54.1, w1:123, w2:53, c1:0, c2:355, c3:0, s1:280, s2:0, s3:654, g1:796, g2:0, g3:0, g4:0, a1:0, a2:3.55, a3:0, a6:0 },
  { name:"25-30-150", code:"2704", wb:42.5, sa:54.2, w1:126, w2:54, c1:0, c2:381, c3:42, s1:267, s2:0, s3:0, g1:759, g2:0, g3:0, g4:0, a1:0, a2:4.23, a3:0, a6:0 }
];

const DEFAULT_DISPATCH_DEFAULTS = { roundTrip:30, workHours:7, loadPerTruck:6, owned:5, rental:0, target:100 };
...
async function getDispatchDefaults(){
  const client = getDb();
  if (!client) return { ...DEFAULT_DISPATCH_DEFAULTS };
  const { data, error } = await client.from("dispatch_settings").select("*").eq("id", 1).single();
  if (error || !data) return { ...DEFAULT_DISPATCH_DEFAULTS };
  return {
    roundTrip: Number(data.round_trip || 0),
    workHours: Number(data.work_hours || 0),
    loadPerTruck: Number(data.load_per_truck || 0),
    owned: Number(data.owned || 0),
    rental: Number(data.rental || 0),
...
async function saveDispatchDefaultsToDb(d){
  ...
  const { error } = await client.from("dispatch_settings").upsert([{
    id: 1,
